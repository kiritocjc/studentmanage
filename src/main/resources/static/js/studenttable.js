layui.use(['table', 'layer','form'], function () {
      ...
      tableIns=table.render({
        elem: "#testtable",
        //请求地址
        url: "getStudentinfoAll",
        //渲染数据
        method:'get',
        page: true,
        cols: [[
          { field: 'aa', type: "checkbox" }, // 表头
          { field: 'studentId', title: 'studentId', width: 80, sort: true }
          , { field: 'name', title: 'name', width: 80 }
          , { field: 'sex', title: 'sex', width: 80, sort: true }
          , { field: 'age', title: 'age', width: 80 }
          , { field: 'teacherId', title: 'teacherId', width: 177 }
          , { field: 'grade', title: 'grade', width: 80 }
          , { field: 'clazz', title: 'clazz', width: 80 }
          , { field: 'titleid', title: 'titleid', width: 80 }
